...
static void test_EdgeList_addFirst(){
    ...
    char * obj1= "Object1";
    Vertex * v=CreateVertex();
    insertLastEdge(c,mem(obj2),v);
    insertFirstEdge(c,mem(obj1),v);
